...
import { App, DomController } from 'ionic-angular';
export declare class ImageViewerTransitionGesture extends PanGesture {
    ...
    private backdrop;
    constructor(platform: Platform, component: ImageViewerComponent, app: App, domCtrl: DomController, renderer: Renderer, cb: Function);
